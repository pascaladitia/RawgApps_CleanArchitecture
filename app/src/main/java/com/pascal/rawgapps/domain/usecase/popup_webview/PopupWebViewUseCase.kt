package com.pascal.rawgapps.domain.usecase.popup_webview
...
class PopupWebViewUseCase @Inject constructor() {
    ...
    operator fun invoke(context: Context, popupLayoutInt: Int, url: String): Dialog {
        ...
        val topTextView =
            dialog.window!!.findViewById<TextView>(R.id.TextView_popup_webview_toptext)
        ...
        val switchToBrowser =
            dialog.window!!.findViewById<ImageView>(R.id.ImageView_popup_webview_switchToBrowser)
