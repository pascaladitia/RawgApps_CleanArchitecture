...
class PlatformListingAdapter(
    var platformList: ArrayList<UIPlatforms>,
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.platform_filter_card, parent, false)
    ...
    override fun onBindViewHolder(holder: PlatformViewHolder, position: Int) {
        ...
        if (selectedItemPos == position) {
            holder.filterName.background = AppCompatResources.getDrawable(
                holder.itemView.context,
                R.drawable.selected_platform_filter_card_rounded
            )
            holder.filterName.setTextColor(holder.itemView.context.resources.getColor(R.color.filter_card_bg_color))
        } else {
            holder.filterName.background = AppCompatResources.getDrawable(
                holder.itemView.context,
                R.drawable.platform_filter_card_rounded
            )
