...
import com.pascal.rawgapps.databinding.FragmentListingBinding
import com.pascal.rawgapps.ui.adapter.GameListingAdapter
import com.pascal.rawgapps.ui.adapter.PlatformListingAdapter
import com.pascal.rawgapps.viewmodel.ListingFragmentViewModel
...
class ListingFragment : Fragment() {
    ...
    private fun getFirstListings() {
        ...
        viewModel.listing.value =
            Gson().fromJson(activity!!.intent.getStringExtra("firstList"), listType)
        viewModel.platforms.value =
            Gson().fromJson(activity!!.intent.getStringExtra("platforms"), platformsType)
    }
    ...
    private fun gameListingAdapterOnClick(position: Int) {
        val toDetailsFragment = ListingFragmentDirections.actionListingFragmentToDetailsFragment(
            viewModel.listing.value!!.get(position).id
        )
    ...
    private fun setupComponents() {
        ...
        binding.RecyclerViewFragmentListingPlatformFilters.layoutManager =
        ...
        binding.SearchViewListingFragment.setOnQueryTextListener(object :
