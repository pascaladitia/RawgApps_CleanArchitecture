package com.pascal.rawgapps.data.remote.service

import com.pascal.rawgapps.BuildConfig
...
interface IRawgAPI {
    ...
    ): Single<RAWGResponseGameDetails>
    ...
    ): Single<RAWGResponsePlatformsResult>

    @GET("games")
    fun getGameListBySearch(
        @Query("key") key: String = BuildConfig.RAWG_KEY,
        @Query("page") page: Int = 1,
    ...
    @GET("games")
    fun getGameListBySearchPlatform(
        @Query("key") key: String = BuildConfig.RAWG_KEY,
        @Query("page") page: Int = 1,
        @Query("page_size") pageSize: Int = 6,
        @Query("search") search: String,
        @Query("platforms") platformID: Int
    ): Single<RAWGResponseGameListResult>
